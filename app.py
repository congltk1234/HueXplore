...
with select_col1:
        ...
        css_styles="""
            .st-dp {
                background-color: rgb(158 139 11 / 84%);
            }
            .st-bu {
